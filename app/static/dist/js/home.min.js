let alertButton=document.querySelector('.alert button');if(alertButton){alertButton.addEventListener('click',function(event){alertButton.parentNode.style.display='none';event.preventDefault();},false);}
function toggleButtons(button1,button2){var userMenu=document.getElementById(button1);var closeUserMenu=document.getElementById(button2);if(userMenu.style.display==='none'){userMenu.style.display='block';closeUserMenu.style.display='none';}else{userMenu.style.display='none';closeUserMenu.style.display='block';}}
